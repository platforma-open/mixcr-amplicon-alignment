...
export type MixcrAmpliconAlignmentBlockContract = BlockContract;
export type MixcrAmpliconAlignmentBlockOutputs  = BlockOutputs;
export type MixcrAmpliconAlignmentBlockData     = BlockData;
export const MixcrAmpliconAlignmentBlockPointer = BlockPointer;
